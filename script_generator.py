...
{{
  ...
  "title": "影片標題 ≤25 字。【CTR 強化規則 — 必須同時滿足以下兩項，否則被退回】(1) 至少 1 個情緒詞：震撼/震驚/可怕/恐怖/秘密/懸案/未解/絕命/血腥/詭異/離奇/失控/封存/不敢/絕密；(2) 至少 1 個具體數字 OR 時間點 OR 地名：年份(1968)、人數(7人)、年齡(15歲)、金額(300萬)、天數(30年追查)、地名(東京/府中)。再從以下 6 種 hook 句型擇一(避免重複)：A) 反差句「她救了全村的命，卻親手殺了自己的孩子」 B) 數字句「30年追查，0嫌犯」 C) 禁忌句「警察不敢公開的真相」 D) 倒敘句「他死後，秘密才被翻出來」 E) 質問句「冤案？還是完美犯罪？」 F) 身份句「鄰居眼中的好人，警方檔案裡的惡魔」。範例符合(情緒+數字+句型)：「30年懸案：警方封存的絕密檔案」「7具屍體，0個目擊者」「她毒殺3任丈夫，鄰居都說她是好人」「府中3億搶案：50年未破的完美犯罪」。禁止用「案件名：說明」這種平鋪直敘格式。",
