...
{{
  ...
  "hook": "35–55 字，開場必須立即抓住注意力。6 種手法隨機選一：A) 從結局倒敘 B) 從受害者最後通話/對話開始 C) 用一個反直覺的事實 D) 描述發現屍體的那一刻 E) 用一句當事人的話 F) 用一個數字製造衝擊。禁止「今天我們來聊聊」這種平淡開場。",
  ...
  "cta": "10–20 字，結尾呼籲+導流長影片。例：'完整故事在長影片，追蹤看更多真實懸案' 或 '想知道結局？看我們的完整調查'",
