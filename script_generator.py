...
{{
  ...
  "hook": "25–40 字（上限 40 字！），開場必須立即抓住注意力。6 種手法隨機選一：A) 從結局倒敘 B) 從受害者最後通話/對話開始 C) 用一個反直覺的事實 D) 描述發現屍體的那一刻 E) 用一句當事人的話 F) 用一個數字製造衝擊。禁止「今天我們來聊聊」這種平淡開場。",
  ...
  "cta": "8–15 字（上限 15 字！），結尾必須是一個問題，引導觀眾留言。例：'你覺得他有罪嗎？留言告訴我' 或 '你怎麼看？留言分享'。禁止「追蹤看更多」這種被動 CTA。",
...
_SECTION_CHAR_LIMITS = {
    "hook": 40, "setup": 35, "twist": 50, "aftermath": 55, "cta": 15,
    "event": 30,  # per event
}
